...
namespace LiftLab.Helpers
{
    // test to get all of the fonts from fontawesome. GitHub page was used to source the code from the otf
    // otf file and extract the code into these
